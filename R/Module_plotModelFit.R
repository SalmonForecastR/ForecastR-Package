...
plotModelFit <- function(fit.obj, options= list(plot.which = "all",age.which="all",plot.add=FALSE),fc.add=NULL,subtitle = NULL,tracing = FALSE){
...
bg.col <- rgb(1, 0, 0,bg.fade)
	...
	title(main= paste(fit.obj[[age.plot]]$model.type,age.plot,sep=" - "))
 	title(main= subtitle,line=-2,cex=0.7)   
